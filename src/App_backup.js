...
function App() {
    ...
    const copyScriptToClipboard = async () => {
        if (!selectedIds.length) return alert("선택된 캐릭터가 없습니다.");

        const payload = [
            {
                id: "_meta",
                author: (meta.author || "작가").trim() || "작가",
                name: (meta.name || "제목").trim() || "제목",
            },
            ...selectedIds,
        ];
        ...
        >
            ...
            <div style={{ flex: 2 }}>
                <div style={{ display: "flex", gap: "8px", marginBottom: "16px" }}>
                    ...
                    <button onClick={copyScriptToClipboard}>📋 복사</button>
                </div>
